...
public class CloudRecoEventHandler : MonoBehaviour, ICloudRecoEventHandler
{
    ...
    {
        // This code demonstrates how to reuse an ImageTargetBehaviour for new search 
        // results and modifying it according to the metadata.
        // Depending on your application, it can make more sense to duplicate the ImageTargetBehaviour 
        // using Instantiate(), or to create a new ImageTargetBehaviour for each new result
